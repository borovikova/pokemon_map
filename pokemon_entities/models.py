...
class Pokemon(models.Model):
	...
	picture = models.ImageField(upload_to='pokemons', null=True, verbose_name='картинка покемона')
	description = models.TextField(verbose_name='описание', blank=True)
	parent = models.ForeignKey("self", models.SET_NULL, null=True, related_name='parent_to', verbose_name='из кого эволюционировал', blank=True)
